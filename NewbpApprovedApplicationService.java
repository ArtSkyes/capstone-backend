...
import com.cituccs.bfp.Repository.NewbpApprovedApplicationRepository;
	...
	//update records
		public NewbpApprovedApplicationEntity evaluateApprovedBp(int id, NewbpApprovedApplicationEntity newNewbpApprovedApplicationDetails) throws Exception{
			...
			try {
				...
				newNewbpApprovedApplication.setFire_inspectors(newNewbpApprovedApplicationDetails.getFire_inspectors());
				newNewbpApprovedApplication.setRecommendation(newNewbpApprovedApplicationDetails.getRecommendation());
				
				System.out.println(newNewbpApprovedApplicationDetails.getFire_inspectors());
