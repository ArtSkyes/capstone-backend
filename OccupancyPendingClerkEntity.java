...
public class OccupancyPendingClerkEntity {
	...
	public OccupancyPendingClerkEntity(int id, int control_no, int bldgpermit_no, String applicants_name,
			String project_name, String location, String contact_no, ArrayList<String[]> fees, Date date_received,
			String team_leader, String[] fire_inspectors, int inspection_no, Date date_inspection, String received_name,
	...
	public void setFireInspectors(String[] fire_inspectors) {
		this.fire_inspectors = fire_inspectors;
	}
