...
public class RenewalbpAbatementOrderEntity {
	...
	public RenewalbpAbatementOrderEntity(int id, String bspermit_no, String permittee, String business_name,
			...
			int ntcv_no, Date abatement_date, int abatement_no, String team_leader, String[] fire_inspectors,
			ArrayList<String[]> defects, Date date, String name, double administrative_fine, String remarks) {
		super();
		this.id = id;
