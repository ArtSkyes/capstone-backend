...
import com.cituccs.bfp.Repository.RenewalbpApprovedApplicationRepository;
	...
	//update records
			public RenewalbpApprovedApplicationEntity evaluateApprovedBp(int id, RenewalbpApprovedApplicationEntity newNewbpApprovedApplicationDetails) throws Exception{
				...
				try {
					...
					newRenewalApprovedApplication.setDate_received(newNewbpApprovedApplicationDetails.getDate_received());newRenewalApprovedApplication.setDate_inspection(newNewbpApprovedApplicationDetails.getDate_inspection());
					...
					newRenewalApprovedApplication.setPayment_date(newNewbpApprovedApplicationDetails.getPayment_date());
					...
					newRenewalApprovedApplication.setFireInspectors(newNewbpApprovedApplicationDetails.getFireInspectors());
