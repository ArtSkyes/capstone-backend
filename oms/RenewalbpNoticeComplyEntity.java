...
public class RenewalbpNoticeComplyEntity {
	...
	public RenewalbpNoticeComplyEntity(int id, String bspermit_no, String permittee, String business_name,
			String address, String nature_business, String type_occupancy, String contact_no, String email,
			Date date_received, Date date_inspection, int inspection_no, int ntc_no, Date ntc_date, String remarks,
			String team_leader, String[] fireInspectors, ArrayList<String[]> defects, String received_name,
			Date receivedntc_date, String status) {
		super();
		this.id = id;
		...
		this.receivedntc_date = receivedntc_date;
		this.status = status;
	}
	...
	public Date getReceivedntc_date() {
		return receivedntc_date;
	}


	public void setReceivedntc_date(Date receivedntc_date) {
		this.receivedntc_date = receivedntc_date;
	}
