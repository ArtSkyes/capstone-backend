...
public class NewbpAbatementOrderEntity {
	...
	public NewbpAbatementOrderEntity(int id, String bspermit_no, String permittee, String business_name, String address,
			...
			int abatement_no, Date abatement_date, String remarks, String team_leader, String[] fireInspectors,
			ArrayList<String[]> defects, String received_name, Date receivedabatement_date, String status) {
		super();
		this.id = id;
	...
	public void setReceivedabatement_date(Date receivedabatement_date) {
		this.receivedabatement_date = receivedabatement_date;
	}
