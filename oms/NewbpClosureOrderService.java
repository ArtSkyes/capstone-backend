...
import com.cituccs.bfp.Repository.NewbpClosureOrderRepository;
...
public class NewbpClosureOrderService {
	...
	public NewbpClosureOrderEntity updateNewbpClosureOrder(int id, NewbpClosureOrderEntity newNewbpClosureOrderDetails) throws Exception{
		...
		try {
			...
			newNewbpClosureOrder.setDate_inspection(newNewbpClosureOrderDetails.getDate_inspection());
			...
			newNewbpClosureOrder.setFireInspectors(newNewbpClosureOrderDetails.getFireInspectors());
			newNewbpClosureOrder.setDefects(newNewbpClosureOrderDetails.getDefects());
			newNewbpClosureOrder.setReceived_name(newNewbpClosureOrderDetails.getReceived_name());
			newNewbpClosureOrder.setReceivedclosure_date(newNewbpClosureOrderDetails.getReceivedclosure_date());
			newNewbpClosureOrder.setStatus(newNewbpClosureOrderDetails.getStatus());
