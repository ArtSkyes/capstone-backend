...
public class RenewalbpAbatementOrderEntity {
	...
	private Date receivedabatement_date;
	...
	public RenewalbpAbatementOrderEntity(int id, String bspermit_no, String permittee, String business_name,
			...
			Date ntcv_date, int abatement_no, Date abatement_date, String remarks, String team_leader,
			String[] fireInspectors, ArrayList<String[]> defects, String received_name, Date receivedabatement_date,
			String status) {
		super();
		this.id = id;
		...
		this.receivedabatement_date = receivedabatement_date;
		this.status = status;
	}
	...
	public Date getReceivedabatement_date() {
		return receivedabatement_date;
	}


	public void setReceivedabatement_date(Date receivedntc_date) {
		this.receivedabatement_date = receivedntc_date;
	}
