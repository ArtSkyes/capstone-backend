...
public class NewbpNoticeCorrectViolationEntity {
	...
	public NewbpNoticeCorrectViolationEntity(int id, String bspermit_no, String permittee, String business_name,
			...
			int ntcv_no, String team_leader, String[] fire_inspectors, ArrayList<String[]> defects, String name,
			Date date, double administrative_fine, String remarks) {
		super();
		this.id = id;
