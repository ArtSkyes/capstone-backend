...
@Entity
public class BusinessPendingApplications {
	@Id
	...
	public BusinessPendingApplications(){}

	public BusinessPendingApplications(int id, String bspermit_no, String permittee, String business_name, String address,
			String nature_business, String type_occupancy, String contact_no, String email, Date date_received, String remarks) {
		super();
		this.id = id;
