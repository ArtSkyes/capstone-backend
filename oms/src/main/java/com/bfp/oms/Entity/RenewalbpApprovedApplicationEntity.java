...
public class RenewalbpApprovedApplicationEntity {
	...
	public RenewalbpApprovedApplicationEntity(int id, String bspermit_no, String permittee, String business_name,
			...
			Date date_received, Date date_inspection, int inspection_no, int fsic_no, Date fsic_date, int amount,
			int or_no, Date date, String team_leader, String[] fire_inspectors, String[] recommendation,
			String remarks) {
		super();
		this.id = id;
