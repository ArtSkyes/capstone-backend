...
public class RenewalbpNoticeComplyEntity {
	...
	public RenewalbpNoticeComplyEntity(int id, String bspermit_no, String permittee, String business_name,
			...
			Date date_received, Date date_inspected, int inspection_no, String ntc_date, int ntc_no, String team_leader,
			String[] fire_inspectors, ArrayList<String[]> defects, Date date, String name,
			String administrative_fine, String remarks) {
		super();
		this.id = id;
	...
	public void setFire_inspector(String[] fire_inspectors) {
		this.fire_inspectors = fire_inspectors;
	}
