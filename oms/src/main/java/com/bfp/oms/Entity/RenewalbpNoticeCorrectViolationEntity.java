...
public class RenewalbpNoticeCorrectViolationEntity {
	...
	//basic information
		...
		//date received notice to correct violation
		private Date date;
		private String name;
	...
	public RenewalbpNoticeCorrectViolationEntity(int id, String bspermit_no, String permittee, String business_name,
			...
			int ntcv_no, String team_leader, String[] fire_inspectors, ArrayList<String[]> defects, Date date,
			String name, double administrative_fine, String remarks) {
		super();
		this.id = id;
