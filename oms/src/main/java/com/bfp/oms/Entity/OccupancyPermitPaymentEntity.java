...
@Entity
public class OccupancyPermitPaymentEntity {
	@Id
	...
	public OccupancyPermitPaymentEntity() {}


	public OccupancyPermitPaymentEntity(int id, String payor, String business_permitno, String or_no, String ops_no,
