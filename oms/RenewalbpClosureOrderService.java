...
import com.cituccs.bfp.Repository.RenewalbpClosureOrderRepository;
...
public class RenewalbpClosureOrderService {
	...
	public RenewalbpClosureOrderEntity updateRenewalbpClosureOrder(int id, RenewalbpClosureOrderEntity newRenewalbpClosureOrderDetails) throws Exception{
		...
		try {
			...
			newRenewalbpClosureOrder.setDate_inspection(newRenewalbpClosureOrderDetails.getDate_inspection());
			...
			newRenewalbpClosureOrder.setFireInspectors(newRenewalbpClosureOrderDetails.getFireInspectors());
			newRenewalbpClosureOrder.setDefects(newRenewalbpClosureOrderDetails.getDefects());
			newRenewalbpClosureOrder.setReceived_name(newRenewalbpClosureOrderDetails.getReceived_name());
			newRenewalbpClosureOrder.setReceivedclosure_date(newRenewalbpClosureOrderDetails.getReceivedclosure_date());
			newRenewalbpClosureOrder.setStatus(newRenewalbpClosureOrderDetails.getStatus());
