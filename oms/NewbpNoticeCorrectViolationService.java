...
import com.cituccs.bfp.Repository.NewbpNoticeCorrecViolationRepository;
	...
	//update records
		public NewbpNoticeCorrectViolationEntity updateNewbpNoticeCorrectViolation(int id, NewbpNoticeCorrectViolationEntity newNewbpNoticeCorrectViolationDetails) throws Exception{
			...
			try {
				...
				newNewbpNoticeCorrectViolation.setDate_inspection(newNewbpNoticeCorrectViolationDetails.getDate_inspection());
				...
				newNewbpNoticeCorrectViolation.setFireInspectors(newNewbpNoticeCorrectViolationDetails.getFireInspectors());
				newNewbpNoticeCorrectViolation.setDefects(newNewbpNoticeCorrectViolationDetails.getDefects());
				newNewbpNoticeCorrectViolation.setReceived_name(newNewbpNoticeCorrectViolationDetails.getReceived_name());
				newNewbpNoticeCorrectViolation.setReceivedntcv_date(newNewbpNoticeCorrectViolationDetails.getReceivedntcv_date());
				newNewbpNoticeCorrectViolation.setStatus(newNewbpNoticeCorrectViolationDetails.getStatus());
