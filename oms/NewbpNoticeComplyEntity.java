...
public class NewbpNoticeComplyEntity {
	...
	public NewbpNoticeComplyEntity(int id, String bspermit_no, String permittee, String business_name, String address,
			...
			Date date_inspection, int inspection_no, int ntc_no, Date ntc_date, String remarks, String team_leader,
			String[] fireInspectors, ArrayList<String[]> defects, String received_name, Date receivedntc_date,
			String status) {
		super();
		this.id = id;
